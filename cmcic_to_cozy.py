...
def cat_cmut_to_cozy(cmut):
    dic = {
        ...
        "Vie quotidienne @ Soin du corps / coiffeur / cosmétique":
        "personalCare",
...
catNames = (df["Catégorie"] + " @ " +
            df["Sous-catégorie"]).apply(cat_cmut_to_cozy)
...
print(
    f"ach -t token.js --url {os.environ.get('BASE_URL', '<your cozy URL>')} import cmcic_to_cozy.json"
)
